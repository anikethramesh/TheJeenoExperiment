"""Consolidated Phase 3.5 + 4 eval — Golden runtime path.

Covers:
- Phase 3.5: "go to the red door" golden path with prewarm, 0 LLM calls during render.
- Phase 4: Same task on larger env (16x16), same guardrails.

Migrated from: phase_3_5_golden.py (unchanged logic, same file structure).
"""
